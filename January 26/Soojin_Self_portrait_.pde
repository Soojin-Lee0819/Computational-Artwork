...
void draw() {
  ...
  //background pattern 
  //I wanted to make a background that captures the personality of myself. Overall, I am a very positive, bright and warm person, hence I used sunshie shape as a background pattern  
  // I set x, y position for one big circle, positioned small circle around it and and copy pasted to create rest of the sun shape by adding +X +Y to x, y axis

  //x-axis position for orange 1 circle
  int c; 
   c = 220;

  //y-axis position for orange 1 circle
  int b;
  b= 170;
  ...
  //orange sunlight random animation
 ...
 ellipse (width/2, (height/3)+10, faceWidth, faceHeight);
  ...
  //bangs (It was difficult to learn how to rotate one shape each)
  rotate(radians(-20));
  fill (hair);
